...
// Dynamics
    ...
    , CombustionSmokeEmissionDensityAdjustment(1.0f)
    , CombustionSmokeParticleLifetimeAdjustment(1.0f)
    ...
    , MaxBurningParticlesPerShip(224)
    ...
    , DoEnginesWorkAboveWater(true)
    , WaterPumpPowerAdjustment(1.0f)
    // Fishes
    , NumberOfFishes(118)
    , FishSizeMultiplier(6.0f)
    ...
    , DoApplyPhysicsToolsToShips(true)
