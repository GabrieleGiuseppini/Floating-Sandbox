...
// Dynamics
    ...
    , FloodToolRadius(0.75f)
    , FloodToolFlow(50.0f)
    , FloodToolVelocity(5.0f)
    , InjectAirToolRadius(0.75f)
    , InjectAirToolFlow(50.0f)
    , InjectAirToolVelocity(5.0f)
    , FireExtinguisherRadius(5.0f)
    , BlastToolRadius(6.0f)
    , BlastToolForceAdjustment(1.0f)
    , ScrubRustToolRadius(5.0f)
