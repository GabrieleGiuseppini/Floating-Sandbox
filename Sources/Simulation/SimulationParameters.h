...
struct SimulationParameters
{
    ...
    static float constexpr MaxInteractiveWaveGrowthRateAdjustment = 2.0f;
    ...
    static float constexpr MaxWaterDisplacementWaveHeightAdjustment = 1.5f;
    ...
    float ScrubRustToolRadius;
    static float constexpr MinScrubRustToolRadius = 1.0f;
    static float constexpr MaxScrubRustToolRadius = 20.0f;
