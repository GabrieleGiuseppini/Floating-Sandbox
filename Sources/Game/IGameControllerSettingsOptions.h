...
{
    virtual size_t GetMinSimulationParallelism() const = 0;
    virtual size_t GetMaxSimulationParallelism() const = 0;
    ...
    virtual float GetMinSmokeMassAdjustment() const = 0;
    virtual float GetMaxSmokeMassAdjustment() const = 0;

    virtual float GetMinSmokeEmitterSmokeEmissionDensityAdjustment() const = 0;
    virtual float GetMaxSmokeEmitterSmokeEmissionDensityAdjustment() const = 0;

    virtual float GetMinSmokeEmitterSmokeParticleLifetimeAdjustment() const = 0;
    virtual float GetMaxSmokeEmitterSmokeParticleLifetimeAdjustment() const = 0;

    virtual float GetMinCombustionSmokeEmissionDensityAdjustment() const = 0;
    virtual float GetMaxCombustionSmokeEmissionDensityAdjustment() const = 0;

    virtual float GetMinCombustionSmokeParticleLifetimeAdjustment() const = 0;
    virtual float GetMaxCombustionSmokeParticleLifetimeAdjustment() const = 0;
    ...
    virtual float GetMinInteractiveWaveGrowthRateAdjustment() const = 0;
    virtual float GetMaxInteractiveWaveGrowthRateAdjustment() const = 0;
    ...
    virtual float GetMinUnderwaterPlantsDensity() const = 0;
    virtual float GetMaxUnderwaterPlantsDensity() const = 0;

    virtual float GetMinUnderwaterPlantSizeMultiplier() const = 0;
    virtual float GetMaxUnderwaterPlantSizeMultiplier() const = 0;
    ...
    virtual float GetMinNpcPassiveBlastRadiusAdjustment() const = 0;
