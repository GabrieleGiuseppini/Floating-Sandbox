    ...
    , mDisplayUnitsSystem(displayUnitsSystem)
{
    ...
    // Canvas
    {
        // Canvas size
        {
            // Icon
            {
                auto * staticBitmap = new wxStaticBitmap(this, wxID_ANY, WxHelpers::LoadBitmap("image_size_icon", gameAssetManager));
        ...
        // Tool coordinates
        {
            // Icon
            {
                auto * staticBitmap = new wxStaticBitmap(this, wxID_ANY, WxHelpers::LoadBitmap("position_icon", gameAssetManager));
                hSizer->Add(staticBitmap, 0, wxALIGN_CENTRE_VERTICAL, 0);
            }
        ...
        // Selection size
        {
            // Icon
            {
                auto * staticBitmap = new wxStaticBitmap(this, wxID_ANY, WxHelpers::LoadBitmap("selection_size_icon", gameAssetManager));
                hSizer->Add(staticBitmap, 0, wxALIGN_CENTRE_VERTICAL, 0);
            }
        ...
        // Sampled data
        {
            // Icon
            {
                auto * staticBitmap = new wxStaticBitmap(this, wxID_ANY, WxHelpers::LoadBitmap("sampler_icon_small", gameAssetManager));
                hSizer->Add(staticBitmap, 0, wxALIGN_CENTRE_VERTICAL, 0);
            }
        ...
        // Zoom
        {
            // Icon
            {
                auto * staticBitmap = new wxStaticBitmap(this, wxID_ANY, WxHelpers::LoadBitmap("zoom_icon_small", gameAssetManager));
                hSizer->Add(staticBitmap, 0, wxALIGN_CENTRE_VERTICAL, 0);
            }
    ...
    // Ship
    {
        // Mass
        {
            // Icon
            {
                auto * staticBitmap = new wxStaticBitmap(this, wxID_ANY, WxHelpers::LoadBitmap("weight_icon_small", gameAssetManager));
                hSizer->Add(staticBitmap, 0, wxALIGN_CENTRE_VERTICAL, 0);
            }
    ...
    mMeasuringTapeToolBitmap = WxHelpers::LoadBitmap("measuring_tape_icon_small", gameAssetManager);
}
