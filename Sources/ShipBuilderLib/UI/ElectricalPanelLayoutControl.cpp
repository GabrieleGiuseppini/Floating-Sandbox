...
ElectricalPanelLayoutControl::ElectricalPanelLayoutControl(
    ...
    : mElementBitmap(WxHelpers::LoadBitmap("electrical_panel_edit_element", gameAssetManager))
    , mElementShadowBitmap(WxHelpers::LoadBitmap("electrical_panel_edit_element_shadow", gameAssetManager))
