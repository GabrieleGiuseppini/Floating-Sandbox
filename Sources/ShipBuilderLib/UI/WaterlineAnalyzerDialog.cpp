...

    {
        ...
        // Play continuously button
        {
            mPlayContinuouslyButton = new wxBitmapButton(
                this,
                wxID_ANY,
                WxHelpers::LoadBitmap("play_icon_medium", gameAssetManager));
        ...
        // Play step-by-step button
        {
            mPlayStepByStepButton = new wxBitmapButton(
                this,
                wxID_ANY,
                WxHelpers::LoadBitmap("play_step_icon_medium", gameAssetManager));
        ...
        // Rewind button
        {
            mRewindButton = new wxBitmapButton(
                this,
                wxID_ANY,
                WxHelpers::LoadBitmap("rewind_icon_medium", gameAssetManager));
        ...
        // Outcome control
        {
            mOutcomeControl = new WaterlineAnalysisOutcomeVisualizationControl(this, gameAssetManager);
