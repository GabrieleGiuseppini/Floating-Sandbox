...
RgbaImageData TextureAlignmentOptimizer_TODO2::OptimizeAlignment(
...
void TextureAlignmentOptimizer_TODO2::CalculateEdges(
	RgbaImageData const & source,
...
std::vector<TextureAlignmentOptimizer_TODO2::Segment> TextureAlignmentOptimizer_TODO2::CalculateSegments(
...
std::pair<int, int> TextureAlignmentOptimizer_TODO2::CalculateOptimalOffsets(
...
float TextureAlignmentOptimizer_TODO2::CalculateWasteOnLeftEdge(
	std::vector<Segment> const & leftXSegments,
	int offset,
	int structureMeshSize,
	int textureSize)
...
float TextureAlignmentOptimizer_TODO2::CalculateWasteOnRightEdge(
	std::vector<Segment> const & rightXSegments,
	int offset,
	int structureMeshSize,
	int textureSize)
