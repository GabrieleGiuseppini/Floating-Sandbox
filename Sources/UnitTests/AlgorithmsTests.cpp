...
TEST(AlgorithmsTests, DiffuseLight_NeonVectorized_4Lamps)
{
    ...
    // NEON uses reciprocal estimates without refinement for lighting.
    EXPECT_NEAR(0.7527864f, outLightBuffer[1], 0.001f);
    ...
    EXPECT_NEAR(0.17639320225f, outLightBuffer[3], 0.001f);
}
