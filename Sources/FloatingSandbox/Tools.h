...
private:
    ...
    // Our state:
    //  - When not set: we are in hovering mode; at mouse down we check and either do action or go to selection mode
    //  - When set: we are in selection mode; at mouse up we do action, and reset
