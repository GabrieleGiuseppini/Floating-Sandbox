...
void CreditsPanel::RenderCredits(wxSize panelSize)
{
    ...
    std::vector<Title> titles = {
        ...
        {2, wxS("MasterGarfield    Aur\xe9lien WOLFF    Alex di Roma    2017 Leonardo    FER ZCL    AvSimplified    Ha-Ha Hans    Tomás Sánchez"), 0},
        {2, wxS("Mia    Truce#3326    RetroGraczzPL    Nomadavid    Wreno    R.M.S. Atlantic    Golden    doctor1922    Techo    Titania    Late"), 0},
        {2, wxS("Matthew Anderson    DennisDanielGrimaldo    blue_funnel    Charles Calvin    Denis    Aqua    Hellooping    Ventrix    M2L"), VMargin3},
