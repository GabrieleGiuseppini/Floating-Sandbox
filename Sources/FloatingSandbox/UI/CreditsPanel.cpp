...
void CreditsPanel::RenderCredits(wxSize panelSize)
{
    ...
    std::vector<Title> titles = {
        ...
        {2, wxS("JackTheBrickfilmMaker    Michael Bozarth    Officer TimCan    Darek225    HummeL    Mattytitanic    LostLinerLegend"), 0},
        {2, wxS("Albert Windsor    Takara    Rockabilly Rebel    McShooter2018    sinking_feeling    braun    P1X    Higuys153    QHM"), 0},
        {2, wxS("Dumbphones    NotTelling    Hugo_2503    _ASTYuu_    Serhiiiihres    CPM    MTF    Gustav Shedletsky    elkarlos"), 0},
        {2, wxS("MasterGarfield    Aur\xe9lien WOLFF    Alex di Roma    2017 Leonardo    FER ZCL    AvSimplified    Ha-Ha Hans"), 0},
        {2, wxS("Kazindel    Fox Assor    Pocketwatch    Mrs. Magic    Kiko    Tomás Sánchez    Captain Henry"), VMargin3},
