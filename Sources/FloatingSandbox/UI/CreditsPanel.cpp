...
void CreditsPanel::RenderCredits(wxSize panelSize)
{
    ...
    std::vector<Title> titles = {
        ...
        {2, wxS("Pandadude12345    John Smith    Dkuz    Loree    Daewoom    Arkstar_    BeamierBoomer    KV Mauvmellow    Longhorn"), 0},
        {2, wxS("Pac0master    CorbinPasta93    Yorkie    Bluefox    Raynair    Menta1ity    Transportation Fan    BumBumBaby    LJKMagic"), 0},
        {2, wxS("Matthew Anderson    DennisDanielGrimaldo    blue_funnel    Charles Calvin    Denis    Aqua    Hellooping    Ventrix    M2L"), 0},
        {2, wxS("MasterGarfield    Aur\xe9lien WOLFF    Alex di Roma    2017 Leonardo    FER ZCL    AvSimplified    Ha-Ha Hans    Sylas Reece"), 0},
        {2, wxS("Mia    Truce#3326    RetroGraczzPL    Nomadavid    Wreno    R.M.S. Atlantic    Golden    doctor1922    Techo    Titania    Late"), 0},
        {2, wxS("Kazindel    Fox Assor    Pocketwatch    Mrs. Magic    Kiko    Tomás Sánchez    Captain Henry    Kubusi0192    FacundoAR657"), 0},
        {2, wxS("JackTheBrickfilmMaker    Michael Bozarth    Officer TimCan    Darek225    HummeL    Mattytitanic    LostLinerLegend    Saffyre"), 0},
        {2, wxS("Dumbphones    NotTelling    Hugo_2503    _ASTYuu_    Serhiiiihres    CPM    MTF    Gustav Shedletsky    elkarlos    KAlexAlex1721"), VMargin3},
