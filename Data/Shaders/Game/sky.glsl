...
void main()
{
    ...
    vec3 lowerColor = mix(paramCrepuscularColor, paramFlatSkyColor, max((paramEffectiveAmbientLightIntensity - 0.5) * (1.0/0.5), 0.0));
    lowerColor = mix(paramEffectiveMoonlightColor * 0.6, lowerColor * paramEffectiveAmbientLightIntensity, min(paramEffectiveAmbientLightIntensity * (1.0/0.5), 1.0));
