...
void main()
{
    ...
    float removalDepth = (lum + removalProgressSquare) * 1.5;
    removalDepth *= removalProgressSquare;
    vec3 removalColor = vec3(NPC_REMOVAL_COLOR);
    c.rgb = mix(
        c.rgb,
        min(
            removalColor,
