...
# Troubleshooting
Many Linux distributions now use Wayland for their desktop envrionments, and Floating Sandbox will encounter an error when launching. To rectify this, put the envrionment variable "GDK_BACKEND=x11" in the terminal, then followed by the game executable name.
