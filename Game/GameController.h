...
public:
    ...
    bool GetDoEnginesWorkAboveWater() const override { return mGameParameters.DoEnginesWorkAboveWater; }
    void SetDoEnginesWorkAboveWater(bool value) override { mGameParameters.DoEnginesWorkAboveWater = value; }
