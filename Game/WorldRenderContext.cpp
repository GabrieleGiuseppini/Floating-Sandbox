    ...
    // Calculated params
{
    ...
    glVertexAttribPointer(static_cast<GLuint>(VertexAttributeType::OceanBasic), (2 + 1), GL_FLOAT, GL_FALSE, (2 + 1) * sizeof(float), (void *)0);
    CheckOpenGLError();
    ...
    glEnableVertexAttribArray(static_cast<GLuint>(VertexAttributeType::OceanDetailed));
    static_assert(sizeof(OceanDetailedSegment) == 3 * 2 * sizeof(float));
    glVertexAttribPointer(static_cast<GLuint>(VertexAttributeType::OceanDetailed), (2 + 1), GL_FLOAT, GL_FALSE, (2 + 1) * sizeof(float), (void *)0);
    CheckOpenGLError();
