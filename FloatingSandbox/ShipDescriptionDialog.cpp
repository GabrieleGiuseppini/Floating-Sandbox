    ...
    , mUIPreferences(std::move(uiPreferences))
{
...

    {
        if (isAutomatic)
        {
            ...
            dontChk->SetToolTip("Prevents ship descriptions from being shown each time a ship is loaded. You can always change this setting later from the \"Preferences\" window.");
