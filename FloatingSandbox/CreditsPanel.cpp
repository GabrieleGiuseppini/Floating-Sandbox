...
void CreditsPanel::RenderCredits(wxSize panelSize)
{
    ...
    std::vector<Title> titles = {
        ...
        {2, wxS("Matthew Anderson    DennisDanielGrimaldo    blue_funnel    Charles Calvin    Denis"), 0},
        {2, wxS("Dumbphones    NotTelling    Hugo_2503    _ASTYuu_    Serhiiiihres    Floeddy    CPM"), 0},
        {2, wxS("Albert Windsor    Takara    Rockabilly Rebel    McShooter2018    sinking_feeling    braun"), 0},
        {2, wxS("Pandadude12345    John Smith    Dkuz    Loree    Daewoom    Aqua    Arkstar_    BeamierBoomer"), 0},
        ...
        {2, wxS("TopHatLemons    Truce#3326    RetroGraczzPL    Nomadavid    Wreno    R.M.S. Atlantic    Pocketwatch"), 0},
