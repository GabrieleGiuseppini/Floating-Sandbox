...
void CreditsPanel::RenderCredits(wxSize panelSize)
{
    ...
    std::vector<Title> titles = {
        ...
        {2, wxS("TopHatLemons    Truce#3326    RetroGraczzPL    Nomadavid    Wreno    R.M.S. Atlantic"), 0},
        {2, wxS("Albert Windsor    Takara    Rockabilly Rebel    McShooter2018    sinking_feeling    braun"), 0},
        {2, wxS("Dumbphones    NotTelling    Hugo_2503    _ASTYuu_    Serhiiiihres    CPM    Pocketwatch"), 0},
        {2, wxS("Matthew Anderson    DennisDanielGrimaldo    blue_funnel    Charles Calvin    Denis    Aqua"), 0},
        {2, wxS("Pac0master    CorbinPasta93    Yorkie    Bluefox    KikoTheBoatBuilder    Raynair    Menta1ity"), 0},
        {2, wxS("MasterGarfield    Aur\xe9lien WOLFF    Alex di Roma    2017 Leonardo    FER ZCL    AvSimplified"), 0},
        {2, wxS("Pandadude12345    John Smith    Dkuz    Loree    Daewoom    Arkstar_    BeamierBoomer    Kazindel"), 0},
